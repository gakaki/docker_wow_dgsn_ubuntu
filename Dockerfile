...
RUN rm -rf /etc/apt/sources.list && echo "deb http://mirrors.aliyun.com/ubuntu/ xenial main restricted universe multiverse \ 
...
&& apt-get install -y --no-install-recommends  curl bridge-utils clang libicu-dev bridge-utils \
